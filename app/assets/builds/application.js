(() => {
  ...
  var import_turbo_rails = __require("@hotwired/turbo-rails");
  var import_stimulus2 = __require("@hotwired/stimulus");

  // app/javascript/controllers/theme_controller.js
  var import_stimulus = __require("@hotwired/stimulus");
  var theme_controller_default = class extends import_stimulus.Controller {
    connect() {
  ...
  window.Turbo = import_turbo_rails.Turbo;
  window.ApexCharts = import_apexcharts.default;
  var application = import_stimulus2.Application.start();
